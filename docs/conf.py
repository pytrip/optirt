...
try:
    release = pkg_resources.get_distribution('optirt').version
except pkg_resources.DistributionNotFound:
    print('optirt must be installed to build the documentation.')
...
latex_documents = [
    (master_doc, 'optirt.tex', 'optirt Documentation',
     'Author', 'manual'),
]
...
man_pages = [
    (master_doc, 'optirt', 'optirt Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'optirt', 'optirt Documentation',
     author, 'optirt', 'One line description of project.',
     'Miscellaneous'),
]
